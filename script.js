/* ═══════════════════════════════════════════════════════════════
   Valentine's Day — script.js (CORREGIDO)
═══════════════════════════════════════════════════════════════ */
...
function moveNo() {
    // 1. Activar el modo flotante si es la primera vez
    if (!isNoMoved) {
        isNoMoved = true;
        btnNoStatic.style.display = 'none'; // Desaparece el estático
        btnNoFloating.classList.remove('hidden');
        btnNoFloating.style.pointerEvents = 'auto'; // ACTIVAR CLICS
    }

    // 2. Calcular nueva posición aleatoria
    // Restamos un margen para que no se salga de la pantalla
    const padding = 20;
...
function handleSi() {
    ...
    // Ocultar botones NO para que no estorben
...
function handleClose() {
    location.reload(); // La forma más limpia de resetear todo al inicio
}
